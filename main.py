        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_1:
                    ...
                    #print("Key 7 pressed")
                    board.move_stones(screen, 7, pocket_ind)
                elif event.key == pygame.K_8:
                    #print("Key 8 pressed")
                    board.move_stones(screen, 8, pocket_ind)
                elif event.key == pygame.K_9:
                    #print("Key 9 pressed")
                    board.move_stones(screen, 9, pocket_ind)
                elif event.key == pygame.K_0:
                    #print("Key 0 pressed")
                    board.move_stones(screen, 10, pocket_ind)
                elif event.key == pygame.K_EQUALS:
                    #print("Key Equals pressed")
                    board.move_stones(screen, 12, pocket_ind)
                elif event.key == pygame.K_MINUS:
                    #print("Key Minus pressed")
                    board.move_stones(screen, 11, pocket_ind)
